 ...
 */
func greeting() {
    let welcome = "Welcome to Flatiron iOS Fall semester!"
    print(welcome)
}
greeting()
greeting()
 ...
 */
func greetMe(personName: String) {
    print("Hi there \(personName)! We're so glad to have you here!")
}
greetMe("Arvin")
greetMe("Shiela")
 ...
 */
var anotherPerson = "May"

greetMe(anotherPerson)
anotherPerson = "Arbin"
greetMe(anotherPerson)
 ...
 */
func printThisLine() {
    var someLine = "This is a sentence."
    print(someLine)
    var anotherLine = someLine
    print(someLine)
}
